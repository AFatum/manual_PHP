...
{
  private $c = 3; // 2.1 - создаём отдельное свойство, т.к. предыдущее приватное и в наследнике не будет видно
  public $d = 4;
...
#### <a name="inn"></a> Полиморфизм (итерфейсы и абстрактные классы): 
[Наверх](#Up)
